...
public class LoginForm {
	...
	public static LoginStatus login(String username, String password, String validation) {
		...
		if (validation == null || validation.length()==0) 
	        return new LoginStatus(false, "Empty validation code");
		
		if (!validation.equals(VALIDATION_CODE)) 
	        return new LoginStatus(false, "Wrong validation code");
