    ...
    public static void main( String[] args )
    {
		...
		*/
    	try {
            ...
            int choice = 3; // Change this to 1 or 2 based on your preference
            ...
            if (choice == 1) {
                ...
                // Execute operation for Officeworks registration page
                SeleniumOperations.officeworks_registration_page_Credit("https://www.officeworks.com.au/app/identity/create-account");
            } 
            else {
