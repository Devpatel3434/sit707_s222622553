...
public class SeleniumOperations {
	...
	public static void officeworks_registration_page_Credit(String url) throws IOException {
		// Step 1: Locate chrome driver folder in the local drive.
		System.setProperty("webdriver.chrome.driver", "C:/chromedriver-win/chromedriver-win/chromedriver.exe");
...
//        element3.sendKeys("test3");
//        email.sendKeys("ediriv946@otemdi.com");
//        password.sendKeys("Test@_51");
//        confirmPassword.sendKeys("Test@_61");
